...
func main() {
	...
	response, err := client.ListTransfers(ctx, &intx.ListTransfersRequest{
		Portfolios: "018a04e1-2006-7e1c-912e-23c2eb75f06f",
	})
...
//	ctx := context.Background()
//
//	response, err := client.UpdatePortfolio(ctx, &intx.UpdatePortfolioRequest{
//		Name:      "jeff-secondary-portfolio1",
//		Portfolio: "1w98n1ex-1-0",
//	})
//
//	if err != nil {
//		fmt.Println("Error listing portfolios:", err)
